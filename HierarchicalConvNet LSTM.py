...
lstm1= Bidirectional(LSTM(51,return_sequences=True,dropout=0.3,recurrent_dropout=0.2))
lstm2= Bidirectional(LSTM(41,return_sequences=True,dropout=0.3,recurrent_dropout=0.2))
lstm3= Bidirectional(LSTM(31,return_sequences=True,dropout=0.3,recurrent_dropout=0.2))
lstm4= Bidirectional(LSTM(21,return_sequences=True,dropout=0.3,recurrent_dropout=0.2))
...
u=keras.layers.concatenate([shared_GlobalMaxPool(lstm1_),shared_GlobalMaxPool(lstm2_),shared_GlobalMaxPool(lstm3_),shared_GlobalMaxPool(lstm4_)],axis=-1)
x=Dense(64)(u)
x=LeakyReLU()(x)
x=Dropout(0.2)(x)
...
plot_model(model,'Hierarchical_Conv_Net_LSTM.png')
destination='./Hierarchical_Conv_Net_LSTM/'
